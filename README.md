...
The package contains three main sets of functions: 1. Cleaning functions
2. Plotting functions (in the form of
[ggplot2](https://ggplot2.tidyverse.org/) geoms) 3. Mapping functions
...
There is two cleaning function: 1. eq\_location\_clean() 2.
eq\_clean\_data()
...
Two plotting functions exist: 1. geom\_timeline 2. geom\_timeline\_label
